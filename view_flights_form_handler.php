...
<html>
	...
	<body>
		...
		<center><h2 style="color:#47E024;">AVAILABLE FLIGHTS</h2></center>
		<?php
			if(isset($_POST['Search']))
			{
				...
				if(empty($data_missing))
				{
					...
					if($class=="economy")
					{
						...
						{
							echo "<center><h3 style=\"color:orange;\">No flights are available !</h3></center>";
						}
						else
						{
							
							echo "<form action=\"book_tickets2.php\" method=\"post\">";
							echo "<table style=margin-left:180px; cellpadding=\"10\"";
							...
							while(mysqli_stmt_fetch($stmt)) {
								...
								<td>".$arrival_time."</td>
								<td>&#x20b9; ".$price_economy."</td>
								<td><input type=\"radio\" checked name=\"select_flight\" value=\"".$flight_no."\"></td>
								</tr>";
								}
								else{
									echo "<tr>
								...
								<td>".$arrival_time."</td>
								<td>&#x20b9; ".$price_economy."</td>
								<td><input type=\"radio\" required name=\"select_flight\" value=\"".$flight_no."\"></td>
								</tr>";
								}
    						}
    						echo "</table> <br>";
    						echo "<input class=\"submit\" type=\"submit\" value=\"Select Flight\" name=\"Select\">";
    						echo "</form>";
    					}
					}
