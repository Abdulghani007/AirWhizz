...
<html>
	...
	<body>
		...
		<center><h2 style="color:#47E024;">VIEW BOOKED FLIGHT TICKETS</h2></center>
		...
		<?php
			...
			if(mysqli_stmt_num_rows($stmt)==0)
			{
				echo "<h3 style=color:orange;><center>No trips completed in the past 30 days!</center></h3>";
			}
			else
			{
				echo "<table cellpadding=\"10\"";
