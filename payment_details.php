...
<html>
	...
	<body>
		...
		<form action="payment_details_form_handler.php" method="post">
			<h2 style="color:#47E024;">ENTER THE PAYMENT DETAILS</h2>
			<h3 style="margin-left: 30px;color:orange;"><u>Payment Summary</u></h3>
			<?php
				...
				echo "<td class=\"fix_table\"><b><label style=\"color:#47E024;\">&#x20b9 ".$total_ticket_price."</label></b></td>";
				echo "</tr>";

				echo "<tr>";
				echo "<td class=\"fix_table\">Meal Combo Charges:</td>";
				echo "<td class=\"fix_table\"><b><label style=\"color:#47E024;\">&#x20b9 ".$total_meal_price."</label></b></td>";
				echo "</tr>";

				echo "<tr>";
				echo "<td class=\"fix_table\">Priority Checkin Fees:</td>";
				echo "<td class=\"fix_table\"><b><label style=\"color:#47E024;\">&#x20b9 ".$total_priority_checkin_fee."</label></b></td>";
				echo "</tr>";

				echo "<tr>";
				echo "<td class=\"fix_table\">Lounge Access Fees:</td>";
				echo "<td class=\"fix_table\"><b><label style=\"color:#47E024;\">&#x20b9 ".$total_lounge_access_fee."</label></b></td>";
				echo "</tr>";

				echo "<tr>";
				echo "<td class=\"fix_table\">Insurance Fees:</td>";
				echo "<td class=\"fix_table\"><b><label style=\"color:#47E024;\">&#x20b9 ".$total_insurance_fee."</label></b></td>";
				echo "</tr>";

				echo "<tr>";
				echo "<td class=\"fix_table\">Discount:</td>";
				echo "<td class=\"fix_table\"><b><label style=\"color:#47E024;\">&#x20b9 ".$total_discount."</label></b></td>";
				echo "</tr>";
				...
				echo "<td class=\"fix_table\"><b><label style=\"color:orange;\">&#x20b9 ".$total_amount."</label></b></td>";
				echo "</tr>";
				echo "</table>";
				echo "<hr style='margin-right:900px; margin-left: 50px'>";
				echo "<br>";
				echo "<p style=\"margin-left:50px\">Your Payment/Transaction ID is <strong style=\"color:orange;\">".$payment_id.".</strong> Please note it down for future reference.</p>";
				echo "<br>";
			?>
