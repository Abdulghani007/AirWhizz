...
<html>
	...
	<body>
		...
		<center><h2 style="color:#47E024;">LIST OF BOOKED TICKETS FOR THE FLIGHT</h2></center>
		<?php
			if(isset($_POST['Submit']))
			{
				...
				if(empty($data_missing))
				{
					...
					{
						echo "<center><h3 style=\"color:orange;\">No booked tickets information is available!</h3><c/center>";
					}
					else
					{
