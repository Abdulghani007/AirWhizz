...
<html>
	...
	<body>
		...
		<center><h2 style="color:#47E024;">VIEW BOOKED TICKETS STATISTICS</h2>
		<?php
			if(isset($_POST['Submit']))
			{
				...
				if(empty($data_missing)) 
				{
					...
					{
						echo "<h3 style=color:orange;>No flights statistics are available !</h3>";
					}
					else
					{
						...
						while(mysqli_stmt_fetch($stmt)) {
        					...
        					<td>".$flight_no."</td>
        					<td>".$journey_date."</td>
							<td style=\"color:#47E024; font-weight:bold;\">".$no_of_tickets_booked."</td>
